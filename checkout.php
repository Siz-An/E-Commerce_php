   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="e.g. real address" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>province :</span>
            <input type="text" name="province" placeholder="e.g. Bagmati" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
